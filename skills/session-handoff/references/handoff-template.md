...
Use this template structure when creating handoff documents. Pre-fill metadata sections from git state; complete the remaining sections based on session context.
